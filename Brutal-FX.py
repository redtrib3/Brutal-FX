...
def twitter():
    password_list = io.open(options.list_password, "r").readlines()
    try_login = 0
    print(f"{Y}\rTwitter Account: {options.twitter}{W}")
...
# NOTE: Hey, I know that the code is badly written, i was a beginner back when i wrote it, please feel free to change the code yourself :) thanks
